...
class RegisterMandateRecordTest extends \PHPUnit_Framework_TestCase
{
    public function testCreateRegisterMandateRecord()
    {
        ...
        $strRecord = (new RegisterMandateRecord($creditor, $debtor, $formatters))->getRecord();

        $this->assertRegExp(
            '/^04NNNNNNNNNN1111111111111111CCCC00000000000N222222222222\s{24}$/',
            $strRecord
        );
